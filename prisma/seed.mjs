...
async function main() {
  // Admin user
  const passwordHash = await bcrypt.default.hash('admin123456', 12);
  await prisma.adminUser.upsert({
    where: { id: 1 },
    update: {},
    create: { id: 1, username: 'admin', passwordHash },
  });
  ...
  console.log('📋 Login credentials: username=admin, password=admin123456');
